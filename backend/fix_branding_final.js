...
async function fixBrandingFinal() {
  ...
  try {
    console.log('🔧 Final Branding Fix...\n');
    ...
    // Set up system branding with the uploaded images using UPSERT
    ...
    console.log('\n🎉 Final branding fix applied successfully!');
    console.log('\n📱 Next steps:');
