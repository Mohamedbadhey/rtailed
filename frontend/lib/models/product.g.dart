...
_$ProductImpl _$$ProductImplFromJson(Map<String, dynamic> json) =>
    _$ProductImpl(
      ...
      stockQuantity: _stringToDouble(json['stock_quantity']),
      damagedQuantity: _stringToDouble(json['damaged_quantity']),
      lowStockThreshold: _stringToDouble(json['low_stock_threshold']),
...
Map<String, dynamic> _$$ProductImplToJson(_$ProductImpl instance) =>
    <String, dynamic>{
      ...
      'stock_quantity': _doubleToString(instance.stockQuantity),
      'damaged_quantity': _doubleToString(instance.damagedQuantity),
      'low_stock_threshold': _doubleToString(instance.lowStockThreshold),
