...
curl -X GET "https://api.kismayoict.com/api/businesses" -H "Content-Type: application/json" -H "Authorization: Bearer YOUR_TOKEN_HERE" || echo "Note: Backend needs to be running to test endpoint"

echo.
echo Testing pending payments endpoint...
curl -X GET "https://api.kismayoict.com/api/businesses/pending-payments/all" -H "Content-Type: application/json" -H "Authorization: Bearer YOUR_TOKEN_HERE" || echo "Note: Backend needs to be running to test endpoint"

echo.
echo Testing overdue bills endpoint...
curl -X GET "https://api.kismayoict.com/api/businesses/overdue-bills/all" -H "Content-Type: application/json" -H "Authorization: Bearer YOUR_TOKEN_HERE" || echo "Note: Backend needs to be running to test endpoint"
